...
const GENERAL_IMAGERESOLUTION = Test.GENERAL_IMAGERESOLUTION = new ImageResolution();
GENERAL_IMAGERESOLUTION.setResolutionHeight(GENERAL_INT);
GENERAL_IMAGERESOLUTION.setResolutionWidth(GENERAL_INT);

const GENERAL_TOUCHEVENTCAPABILITIES = Test.GENERAL_TOUCHEVENTCAPABILITIES = new TouchEventCapabilities();
...
const GENERAL_SCREENPARAMS = Test.GENERAL_SCREENPARAMS = new ScreenParams();
...
const JSON_GENERAL_SCREENPARAMS = Test.JSON_GENERAL_SCREENPARAMS = {
...
const GENERAL_CHARACTERSET = Test.GENERAL_CHARACTERSET = CharacterSet.CID1SET;

const GENERAL_IMAGEFIELDNAME = Test.GENERAL_IMAGEFIELDNAME = ImageFieldName.graphic;

const GENERAL_IMAGEFIELDNAME_LIST = Test.GENERAL_IMAGEFIELDNAME_LIST = [
    GENERAL_IMAGEFIELDNAME,
];

const GENERAL_FILETYPE_LIST = Test.GENERAL_FILETYPE_LIST = [
    GENERAL_FILETYPE,
];
...
const GENERAL_MEDIACLOCKFORMAT_LIST = Test.GENERAL_MEDIACLOCKFORMAT_LIST = [
...
const GENERAL_DISPLAYTYPE = Test.GENERAL_DISPLAYTYPE = DisplayType.CID;
...
const GENERAL_AUDIOTYPE = Test.GENERAL_AUDIOTYPE = AudioType.PCM;
const GENERAL_BITSPERSAMPLE = Test.GENERAL_BITSPERSAMPLE = BitsPerSample.BitsPerSample_8_BIT;
const GENERAL_SAMPLINGRATE = Test.GENERAL_SAMPLINGRATE = SamplingRate.SamplingRate_8KHZ;
...
const JSON_GENERAL_BUTTON_CAPABILITIES = Test.JSON_GENERAL_BUTTON_CAPABILITIES = {
...
const GENERAL_VIDEOSTREAMINGPROTOCOL = Test.GENERAL_VIDEOSTREAMINGPROTOCOL = VideoStreamingProtocol.RAW;
const GENERAL_VIDEOSTREAMINGCODEC = Test.GENERAL_VIDEOSTREAMINGCODEC = VideoStreamingCodec.H264;

const GENERAL_VIDEOSTREAMINGFORMAT = Test.GENERAL_VIDEOSTREAMINGFORMAT = new VideoStreamingFormat()
    .setProtocolParam(GENERAL_VIDEOSTREAMINGPROTOCOL)
    .setCodec(GENERAL_VIDEOSTREAMINGCODEC);

const GENERAL_VIDEOSTREAMINGFORMAT_LIST = Test.GENERAL_VIDEOSTREAMINGFORMAT_LIST = [GENERAL_VIDEOSTREAMINGFORMAT, GENERAL_VIDEOSTREAMINGFORMAT];

const GENERAL_ADDITIONAL_CAPABILITY = Test.GENERAL_ADDITIONAL_CAPABILITY = new VideoStreamingCapability()
    .setPreferredResolution(GENERAL_IMAGERESOLUTION)
    .setDiagonalScreenSize(GENERAL_NUMBER)
