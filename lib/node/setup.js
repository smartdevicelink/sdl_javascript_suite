...
/**
 * Method to merge folders from a source into a destination
 * @param {String} source - the location of the source
 * @param {String} destination - the location of the destination
 */
...
/**
 * Method to merge folders into temporary folders
 */
