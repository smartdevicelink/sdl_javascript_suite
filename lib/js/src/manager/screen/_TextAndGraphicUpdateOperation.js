...
class _TextAndGraphicUpdateOperation extends _Task {
    ...
    async _start () {
        if (this._getState() === _Task.CANCELED) {
    ...
    _createImageOnlyShowWithPrimaryArtwork (primaryArtwork, secondaryArtwork) {
        ...
        newShow.setGraphic((primaryArtwork !== null && !(this._sdlArtworkNeedsUpload(primaryArtwork))) ? primaryArtwork.getImageRPC() : null);
        newShow.setSecondaryGraphic((secondaryArtwork !== null && !(this._sdlArtworkNeedsUpload(secondaryArtwork))) ? secondaryArtwork.getImageRPC() : null);
    ...
    _assembleShowText (show) {
        ...
        if (this._updatedState.getMediaTrackTextField() !== null && this._shouldUpdateMediaTrackField()) {
            show.setMediaTrack(this._updatedState.getMediaTrackTextField());
        }

        if (this._updatedState.getTitle() !== null && this._shouldUpdateTitleField()) {
    ...
    _assembleTwoLineShowText (show) {
        ...
        if (this._updatedState.getTextField1() !== null && this._updatedState.getTextField1().length > 0) {
        ...
        if (this._updatedState.getTextField2() !== null && this._updatedState.getTextField2().length > 0) {
            if ((this._updatedState.getTextField3() === null || !(this._updatedState.getTextField3().length > 0)) && (this._updatedState.getTextField4() === null || !(this._updatedState.getTextField4().length > 0))) {
            ...
            } else if (this._updatedState.getTextField1() !== null && this._updatedState.getTextField1().length > 0) {
        ...
        if (this._updatedState.getTextField3() !== null && this._updatedState.getTextField3().length > 0) {
            // If text 3 exists, put it in slot 2
            tempString.concat(this._updatedState.getTextField3());
            if (this._updatedState.getTextField3Type() !== null) {
                const typeList = [];
        ...
        if (this._updatedState.getTextField4() !== null && this._updatedState.getTextField4().length > 0) {
            if (this._updatedState.getTextField3() !== null && this._updatedState.getTextField3().length > 0) {
                // If text 3 exists, put it in slot 2 formatted
                tempString.concat(' - ').concat(this._updatedState.getTextField4());
                if (this._updatedState.getTextField4Type() !== null) {
                    const typeList = [];
    ...
    _updateCurrentScreenDataFromShow (show) {
        if (show === null) {
            console.error('Can not updateCurrentScreenDataFromShow from null show');
            return;
        }
    ...
    _shouldUpdatePrimaryImage () {
        ...
        const currentScreenDataPrimaryGraphicName = (this._currentScreenData !== null && this._currentScreenData.getGraphic() !== null) ? this._currentScreenData.getGraphic().getValue() : null;
        const primaryGraphicName = this._updatedState.getPrimaryGraphic() !== null ? this._updatedState.getPrimaryGraphic().getName() : null;
    ...
    _shouldUpdateSecondaryImage () {
        ...
        const currentScreenDataSecondaryGraphicName = (this._currentScreenData !== null && this._currentScreenData.getSecondaryGraphic() !== null) ? this._currentScreenData.getSecondaryGraphic().getValue() : null;
        const secondaryGraphicName = this._updatedState.getSecondaryGraphic() !== null ? this._updatedState.getSecondaryGraphic().getName() : null;
    ...
    // check that having null here IS valid
